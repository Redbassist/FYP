#pragma once
#ifndef BADBULLETRAYCASTCALLBACK_H
#define BADBULLETRAYCASTCALLBACK_H

#include "stdafx.h"

class BadBulletRayCastCallback : public b2RayCastCallback {
public:
	BadBulletRayCastCallback(RayCastCallBack* rc = NULL)
	{
		if (rc == NULL) {
			distance = 10000;
		}
