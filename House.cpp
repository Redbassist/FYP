...
House::House(Vector2f pos, std::vector<Item*>* i) : m_pos(pos), items(i) {
	LoadAssets();
	CreateWalls(); 
} 
...
void House::CreateWalls() { 
	walls.push_back(new Wall(m_pos + Vector2f(0, 10), Vector2f(10 , 100)));
	walls.push_back(new Wall(m_pos + Vector2f(90, 10), Vector2f(10, 100)));
	...
	doors.push_back(new Door(m_pos + Vector2f(195, 270), 90));
	doors.push_back(new Door(m_pos + Vector2f(40, 305), 0));

	containers.push_back(new Container(Vector2f(140, 120), 0, items));
	containers.push_back(new Container(Vector2f(200, 390), 180, items));
	containers.push_back(new Container(Vector2f(-70, 300), 270, items));
}
